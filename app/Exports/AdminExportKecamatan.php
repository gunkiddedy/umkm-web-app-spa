...
class AdminExportKecamatan implements FromView, WithEvents, ShouldAutoSize
{
    private $kecamatan_id;

    public function __construct($kecamatan_id) 
    {
    ...
    {
        $umkm = DB::table('ukms')
           ->where('dfkecamatan_id', '=', $this->kecamatan_id)->get();
        ...
        // dd($umkm);
        return view('exports.umkm-admin-kecamatan', [
            'umkms' => $umkm,
            'totals' => $totals,
            'msg' => $msg
        ]);
