...
class ExportUPD implements FromView, WithEvents, ShouldAutoSize
{
    private $kecamatan_id;
    private $desa_id;
    private $usaha;

    public function __construct($kecamatan_id, $desa_id, $usaha) 
    {
    ...
    public function view(): View
    {
        ...
        // dd($umkm);
        return view('exports.umkm-usaha-per-desa', [
            'umkms' => $umkm,
            'totals' => $totals,
            'msg' => $msg
        ]);
