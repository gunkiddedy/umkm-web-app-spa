...
class ExportKK implements FromView, WithEvents, ShouldAutoSize
{
    private $kecamatan_id;
    private $kriteria;

    public function __construct($kecamatan_id, $kriteria) 
    {
    ...
    public function view(): View
    {
        $umkm = DB::table('ukms')
           ...
           ->where(function ($query) {
               $query->where('kriteria', '=', $this->kriteria);
           })->get();
        ...
        // dd($umkm);
        return view('exports.umkm-kecamatan-kriteria', [
            'umkms' => $umkm,
            'totals' => $totals,
            'msg' => $msg
        ]);
